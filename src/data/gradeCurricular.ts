      ...
      cadeiras: [
        {
          ...
          duration: circuitosDigitais.details.totalDurationSeconds,
          prerequisites: [],
          books: [
            {
        ...
        },
        {
          ...
          duration: matematicaDiscreta.details.totalDurationSeconds,
          prerequisites: [],
          books: [
            {
        ...
        },
        {
          ...
          duration: linguagensProgramacao.details.totalDurationSeconds,
          prerequisites: [],
          books: [
            {
        ...
        },
        {
          ...
          duration: introducaoComputacaoI.details.totalDurationSeconds,
          prerequisites: [],
          books: [
            {
        ...
        },
        {
          ...
          duration: geometriaAnalitica.details.totalDurationSeconds,
          prerequisites: [],
          books: [
            {
      ...
      cadeiras: [
        {
          ...
          duration: calculoI.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: algebraLinear.details.totalDurationSeconds,
          prerequisites: ["Geometria Analítica"],
          books: [
            {
        ...
        },
        {
          ...
          duration: estruturaDeDados.details.totalDurationSeconds,
          prerequisites: [
            "Matemática Discreta",
        ...
        },
        {
          ...
          duration: introducaoComputacaoII.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: programacaoOrientadaObjetos.details.totalDurationSeconds,
          prerequisites: ["Introdução à Ciência da Computação com Python I"],
          books: [
            {
      ...
      cadeiras: [
        {
          ...
          duration: algoritmosEmGrafos.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: arquiteturaComputadoresI.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: probabilidadeEstatistica.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: calculoII.details.totalDurationSeconds,
          prerequisites: ["Cálculo I"],
          books: [
            {
        ...
        },
        {
          ...
          duration: programacaoFuncionalHaskell.details.totalDurationSeconds,
          prerequisites: [],
          books: [
            {
      ...
      cadeiras: [
        {
          ...
          duration: analiseAlgoritmos.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: metodosNumericosI.details.totalDurationSeconds,
          prerequisites: [
            "Introdução à Ciência da Computação com Python I",
            "Cálculo I",
          ],
        ...
        },
        {
          ...
          duration: bancoDeDados.details.totalDurationSeconds,
          prerequisites: [],
          books: [
            {
        ...
        },
        {
          ...
          duration: arquiteturaComputadoresII.details.totalDurationSeconds,
          prerequisites: [
        ...
        },
        {
          ...
          duration: programacaoLogica.details.totalDurationSeconds,
          prerequisites: [],
          books: [
            {
      ...
      cadeiras: [
        {
          ...
          duration: redesDeComputadores.details.totalDurationSeconds,
          prerequisites: [],
          books: [
            {
        ...
        },
        {
          ...
          duration: introducaoEngenhariaSoftware.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: sistemasOperacionais.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: programacaoMatematica.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: fundamentosComputacaoGrafica.details.totalDurationSeconds,
          prerequisites: ["Geometria Analítica"],
          books: [
            {
      ...
      cadeiras: [
        {
          ...
          duration: linguagensFormaisAutomatos.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: inteligenciaArtifical.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: sistemasDistruibuidos.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: teoriaDosGrafos.details.totalDurationSeconds,
          prerequisites: ["Matemática Discreta"],
          books: [
            {
        ...
        },
        {
          ...
          duration: calculoIII.details.totalDurationSeconds,
      ...
      cadeiras: [
        {
          ...
          duration: teoriaDaComputacao.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: deepLearning.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: compiladores.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: computacaoQuantica.details.totalDurationSeconds,
        ...
        },
        {
          ...
          duration: metodologiaDaPesquisa.details.totalDurationSeconds,
          prerequisites: [],
          books: [
            {
      ...
      cadeiras: [
        {
          ...
          lessons: [
            {
              id: "36",
              title: "Ingredientes básicos para o Cálculo",
              type: "video",
        ...
        },
        {
          ...
          lessons: [
            {
              id: "40",
              title: "Algoritmos e Programação em Python",
              type: "video",
      ...
      cadeiras: [
        {
          ...
          lessons: [
            {
              id: "56",
              title: "Cálculo IV (Métodos Matemáticos)",
              type: "video",
        ...
        },
        {
          ...
          lessons: [
            {
              id: "57",
              title: "Introdução a Topologia Geral",
              type: "video",
        ...
        },
        {
          ...
          lessons: [
            {
              id: "58",
              title: "Cálculo com variável complexa",
              type: "video",
