...
export const CourseProgressSelector = ({ courses }: CourseProgressSelectorProps) => {
  return (
    <section className="relative mx-auto grid min-h-90 w-full max-w-7xl gap-6 overflow-hidden rounded-2xl border border-zinc-800/80 bg-zinc-900 p-10 before:pointer-events-none before:absolute before:inset-0 before:bg-linear-to-br before:from-ubl-blue/10 before:via-transparent before:to-ubl-green/10 before:opacity-50 sm:min-h-95 sm:p-12 md:min-h-100 md:p-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.25fr)] lg:items-center lg:min-h-110 lg:p-16">
