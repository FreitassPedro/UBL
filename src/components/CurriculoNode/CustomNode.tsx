...
const CustomNode = ({ data }: CustomNodeProps) => {
    ...
    console.log('Rendering CustomNode:', data.name, 'isSelected:', data.isSelected);
    return (
        <div className={`px-4 py-3 shadow-md rounded-lg border-2 border-stone-400 transition-colors ${background}
