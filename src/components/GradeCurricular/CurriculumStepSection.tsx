            ...
            {nodeView && (
                (
                    <div className="fixed inset-0 z-100 flex items-center justify-center bg-black p-8">
                        <div className="bg-bg-card rounded-xl border w-4/5 h-[80vh] overflow-hidden">
                            <div className="py-2 px-4 bg-gray-800 justify-between flex items-center">
                                <h2 className="text-2xl font-semibold text-white">Currículo: {selectedCourse.curriculo}</h2>
