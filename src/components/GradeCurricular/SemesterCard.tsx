  ...
  return (
    <Collapsible open={isActive} onOpenChange={setIsActive} asChild>
      <li
        ...
        id={`${stage.id}`}
        className={cn(
          "relative rounded-2xl border overflow-hidden shadow-lg shadow-black duration-500 transition-all ease-in-out  border-white/10 hover:border-white/20 hover:bg-zinc-800/80 hover:translate-x-2 flex flex-col",
          isActive
