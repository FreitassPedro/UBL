...
export const Navbar = () => {
    return (
        <header className="sticky top-0 left-0 z-50 py-2 text-zinc-400 bg-gray-950 shadow-xl border-b border-gray-700 ">
            <div className="flex justify-between max-w-7xl mx-auto px-6 py items-center">
                ...
                <div>
                    <div className="bg-green-800/40 rounded-xl text-white/40 font-mono px-4 py-2 cursor-no-drop">Entrar</div>
                </div>
            </div>
        </header>
    )
