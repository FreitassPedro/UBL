    ...
    >
      ...
      >
        <div className="relative shrink-0">
          <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-lg border border-zinc-800 bg-zinc-900 shadow-inner text-lg sm:text-xl font-semibold leading-none tracking-tight text-zinc-400">
