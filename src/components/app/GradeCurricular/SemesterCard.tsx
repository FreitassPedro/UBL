import { SemesterBody } from "@/components/app/GradeCurricular/SemesterBody";
import { SemesterHeader } from "@/components/app/GradeCurricular/SemesterHeader";
...
export const SemesterCard: React.FC<SemesterCardProps> = ({ stage }) => {
  ...
  return (
    ...
    >
      ...
      {isActive && <SemesterBody stage={stage} />}
    </li>
  );
};
