import { BookRecommendation } from "@/components/app/GradeCurricular/BookRecommendation";
...
export const SemesterSubjectItem: React.FC<SubjectCardProps> = ({
  subject,
  index,
}) => {
  ...
  return (
    <li key={index} className="relative group">
      <div
        className={`relative ${getColorBackground()} border border-white/10 hover:border-white/20 px-3 py-2 transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl`}
      >
        {/* Content Container */}
              ...
              <div
                className={`flex items-center gap-1 px-3 py-1 ${
                  subject.prerequisites.length > 0
                    ...
                    : ""
                } bg-linear-to-r  rounded-full  border-white/20`}
              >
