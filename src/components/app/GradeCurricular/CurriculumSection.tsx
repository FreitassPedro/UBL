import { SemesterCard } from "@/components/app/GradeCurricular/SemesterCard";
import NodeGraphVisualization from "@/components/app/NodeGraph/NodeGraphVisualization";
    ...
    <section className="w-full mt-10 py-8" ref={sectionRef}>
      <div className="mx-auto max-w-6xl container">
        <div className="flex items-center justify-between gap-4 mb-4">
          ...
          <button
            className="px-2 py-2 bg-bg-card rounded text-white text-md text-nowrap cursor-pointer"
          ...
          <div className="fixed inset-0 z-100 flex items-center justify-center bg-black p-8">
            <div className="bg-bg-card rounded-xl border border-zinc-600 w-4/5 h-[80vh] overflow-hidden">
              <div className="py-2 px-4 bg-gray-900 border-b border-white/20 justify-between flex items-center">
                ...
                <button
                  className="px-4 py-2 bg-white/20 rounded text-white text-xl cursor-pointer"
