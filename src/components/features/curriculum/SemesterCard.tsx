import { SemesterBody } from "@/components/features/curriculum/SemesterBody";
import { SemesterHeader } from "@/components/features/curriculum/SemesterHeader";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
...
export const SemesterCard = ({ stage }: SemesterCardProps) => {
