...
import { CurriculumSection } from "@/components/app/GradeCurricular/CurriculumSection";
import {
  CurriculoCC,
  CurriculoMatematica,
  type Grade,
...
export default function GradeCurricularPage() {
  const [selectedGrade, setSelectedGrade] = React.useState<Grade | undefined>(
    undefined
  );
  ...
  const cursos = [
    {
      ...
      imgSrc:
        "https://github.com/Universidade-Livre/imagens/blob/main/outras/placeholder.png?raw=true",
    ...
    },
    {
      ...
      imgSrc:
        "https://github.com/Universidade-Livre/imagens/blob/main/outras/ubl_mat.jpeg?raw=true",
  ...
  return (
    <div className="min-h-screen bg-bg-body text-white">
      <main className="relative z-10 flex flex-col items-center space-y-4">
          ...
          <div className="h-full z-10 relative flex items-center justify-center px-6">
            ...
            >
              ...
              <p className="text-xl text-white mb-6 font-light">
                Descubra a liberdade de aprender com nossos cursos online
                gratuitos, desenvolvidos para todos os níveis de conhecimento.
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            {cursos.map((curso, index) => (
              ...
              >
                ...
                <div
                  className={`h-1 ${curso.color} group-hover:animate-pulse`}
                ></div>
                <div className="p-8">
                  <h3 className="text-2xl group-hover:text-3xl font-bold text-gray-100 transition-all duration-300">
                    {curso.curso}
                  </h3>
        ...
        {selectedGrade && <CurriculumSection selectedCourse={selectedGrade} />}
      </main>
    </div>
  );
}
