...
const SyllabusItem: React.FC<{ lesson: Lesson }> = ({ lesson }) => {
  ...
  return (
    ...
    >
      <div
        className={`w-[18px] h-[18px] rounded-full mr-3 flex items-center justify-center text-xs ${statusClass}`}
      >
        {statusContent && (
          ...
          <div>
            ...
            <div className="flex justify-between items-end h-[100px] mt-2 px-2">
              {activityData.map((data) => (
                ...
                >
                  <div
                    className={`w-1.5 rounded-t-sm transition-all duration-500 ease-in-out ${
                      data.isActive
